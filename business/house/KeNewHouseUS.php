 ...
 */
class KeNewHouseUS extends KeSecondHouseUS {
	...
	public function crawlDetail($id) {
		...
		$this->multiReplace($spuPrice, $priceReplacement);
	...
	public function genExcel() {
		...
		foreach ($dataList as $data) {
			...
			$this->multiReplace($priceStr,$priceReplacement);
			foreach ($houseLayout as $idx => $layout) {
				...
				$this->writeHouseEval($originId, $data);
			}
		}
	}
