...
?>
	...
	<div id="col-main">
		<form action="/foreignTradeProducts/addProduct" class="frm" rel="async" method="post">
			<caption> Add Product To Buy</caption>
			<table class="data-tbl frm-tbl">
				...
				<tr>
					...
					<td><input class="txt" type="text" name="product_name"/></td>
					<td></td>
				</tr>
				<tr>
					...
					<td><input class="txt" type="text" name="product_attr"/></td>
					<td></td>
				</tr>
				<tr>
					<td>Link sản phẩm</br>
					...
					<td><input class="txt" type="text" name="product_link"/></td>
					<td></td>
				</tr>
				<tr>
					<td>Đơn giá /sp</br>
				...
				<tr>
					...
					<td><input class="txt" type="number" step="0.01" name="cn_vn_freight"></td>
					<td></td>
				</tr>
				<tr>
					<td>Việt Nam /sp</br>
					...
					<td><input class="txt" type="number" step="0.01" name="vn_freight"></td>
					<td></td>
				</tr>
				<tr>
					<td>Phí mua hàng
					...
					<td><input class="txt" type="number" step="0.01" name="buy_fee"></td>
					<td></td>
				</tr>
				<tr>
					...
					<td><input class="txt" type="number" step="0.01" name="search_fee"></td>
					<td></td>
				</tr>
				<tr>
					...
					<td><input class="txt" type="number" step="0.01" name="insure_fee"></td>
					<td></td>
				</tr>
				<?php echo $TPL; ?>
				</tbody>
